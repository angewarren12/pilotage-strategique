                ...
                <div class="modal-body p-0">
                    ...
                    @else
                        ...
                        @elseif($currentView === 'action')
                            ...
                            <!-- Contenu principal de la vue Action -->
                            <div class="p-4">
                                <div class="row">
                                    <div class="col-md-8">
                                            ...
                                            <div class="hierarchy-card parent-level" style="background: white; border-color: {{ $pilier->getHierarchicalColor(0) }};">
                                                ...
                                                <div class="hierarchy-card parent-level" style="background: white; border-color: {{ $pilier->getHierarchicalColor(1) }};">
                                                    ...
                                                    <div class="hierarchy-body">
                                                        ...
                                                        <div class="stat-item">
                                                            <div class="stat-value" style="color: {{ $pilier->getHierarchicalColor(1) }};">{{ $selectedObjectifStrategique->objectifsSpecifiques->count() }}</div>
                                                            <div class="stat-label">OSP</div>
                                                </div>
                                                        <div class="stat-item">
                                                            <div class="stat-value" style="color: {{ $pilier->getHierarchicalColor(1) }};">{{ $selectedObjectifStrategique->objectifsSpecifiques->sum(function($ospec) { return $ospec->actions->count(); }) }}</div>
                                                ...
                                                <!-- OBJECTIF SPECIFIQUE PARENT (NIVEAU 2) -->
                                                <div class="hierarchy-card parent-level" style="background: white; border-color: {{ $pilier->getHierarchicalColor(2) }};">
                                                    <div class="hierarchy-header" style="background: {{ $pilier->getHierarchicalColor(2) }}; color: {{ $pilier->getTextColor($pilier->getHierarchicalColor(2)) }};">
                                                        ...
                                                        <div class="hierarchy-info">
                                                            <h6 class="mb-2">Objectif Spécifique</h6>
                                                    ...
                                                    <div class="hierarchy-body">
                                                        <div class="hierarchy-stats">
                                                            ...
                                                            <div class="stat-item">
                                                                <div class="stat-value" style="color: {{ $pilier->getHierarchicalColor(2) }};">{{ $selectedObjectifSpecifique->actions->count() }}</div>
                                                                <div class="stat-label">Actions</div>
                                                            </div>
                                                        </div>
                                                        <div class="hierarchy-progress">
                                                ...
                                                <div class="hierarchy-arrow-container">
                                                    <div class="d-flex align-items-center justify-content-center">
                                                        <div class="hierarchy-arrow-line"></div>
                                                        <div class="div class="hierarchy-arrow-head">
                                                            <i class="fas fa-chevron-down"></i>
                                                        </div>
                                                    </div>
                                                </div>
                                                
                                                <!-- ACTION PARENT (NIVEAU 3) -->
                                                <div class="hierarchy-card parent-level" style="background: white; border-color: {{ $pilier->getHierarchicalColor(3) }};">
                                                    ...
                                                    <div class="hierarchy-body">
                                                        <div class="hierarchy-stats">
                                                            ...
                                                            <div class="stat-item">
                                                                <div class="stat-value" style="color: {{ $pilier->getHierarchicalColor(3) }};">{{ $selectedAction->sousActions->count() }}</div>
                        ...
                        <div class="hierarchique-content" id="hierarchiqueContent">
                            ...
                            @if($currentView === 'objectifSpecifique')
                                <div class="p-4">
                                    <div class="row">
                                        <div class="col-md-8">
                                            <div class="d-flex justify-content-between align-items-center mb-4">
